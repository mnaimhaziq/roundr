...
public class GameLobbyController implements Initializable {
    ...
    public void HandleMessageInput() {
        ...
        if (!messageChat.isEmpty()) {
            ...
            addToVBox(message); // Add the message to the chat area
    ...
    // }
        ...
        public void addToVBox(Message message) {

        this.addChatBubble(message.getSenderName() + ": " + message.getContent(), chatVBox);
    }


        public void addChatBubble(String msg, VBox vbox) {
        ...
        textFlow.setStyle("-fx-background-color: rgb(217,217,217);" +
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // To automatically resize and scroll to the latest chat
